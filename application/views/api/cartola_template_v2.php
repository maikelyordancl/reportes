        ...
        <div class="container well">
            ...
            <form class="form-inline" action="">
                ...
                <?php if(!is_null($this->input->get('year')) && $this->input->get('month')) { ?>
                    ...
                    <a href="https://api.aicapitals.cl/exportar/pdfCartola/<?=$cliente['key_encriptada'];?>/<?=$this->input->get('month');?>/<?php echo $this->input->get('year'); ?>" class="btn btn-info" target="_blank"> <i class="fa fa-file"></i> Exportar a PDF</a>
                <?php }else{?>
                <a href="<?php echo current_url(); ?>" class="btn btn-default" target="_blank"> <i class="fa fa-print"></i> Versión para Imprimir</a>
                <a href="https://api.aicapitals.cl/exportar/pdfCartola/<?=$cliente['key_encriptada'];?>/<?=(int)$now->format('m') - 1;?>/<?=$now->format('Y');?>" class="btn btn-info" target="_blank"> <i class="fa fa-file"></i> Exportar a PDF</a>
                <? } ?>
                                ...
                                <div class="panel-body">
                                    <div class="">
                                        ...
                                        <table class="table table-bordered ">
                                            ...
                                            <thead>
                                            <tr>
                                                <th class="text-center"><strong>Período</strong></th>
                                                <th class="text-center"><strong>Instrumento</strong></th>
                                                <th class="text-center"><strong><?=($fondo['categoria'] != 'fip')?'Total Acciones':'Total Cuotas';?></strong></th>
                                                <th class="text-center"><strong><?=($fondo['categoria'] != 'fip')?'Valor Acción':'Valor Cuota';?> Contable a la Fecha</strong></th>
                                                <th class="text-center"><strong>Saldo de Inversión</strong></th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <?php
                                            if (!empty($fondo['resumenes'])) {
                                                foreach ($fondo['resumenes'] as $resumen) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo  $resumen['concepto']; ?></td>
                                                        <?php
                                    ...
                                    <?php if(isset($fondo['comentario'])){ ?>
                                        <div class="alert alert-grey">
                                            <strong>Nota:</strong>
                                            <p><?=$fondo['comentario'];?></p>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>

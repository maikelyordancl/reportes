                                ...
                                <div class="panel-body">
                                                    ...
                                                    <div class="col-xs-12">
                                                            ...
                                                            ?>
                                                                       <!-- hcvSF3xZE7FspNLepU4s --> <!-- Código Bit -->
                                                                            ...
                                                                            <table class="table table-bordered fondo-cartola-claro rounded-cartola p-h3 text-white panel-title">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><?= number_format($inversion_inicial_uf, 0,',','.'); ?></td>
                                                                                        <td><?= number_format($inversion_inicial_clp, 0,',','.'); ?></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>ROE Esperado</td>
                                                                                        <td> UF + <?= number_format($most_rent, 1,',','.');?> %</td>
                                                                                        <td>--</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Devolución Total Esperada</td>
                                                                                        <td><?= number_format($devolucion_total_uf_esp, 0,',','.');?></td>
                                                                                        <td><?= number_format($devolucion_total_clp_esp, 0,',','.');?></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Dividendos Esperados sobre Inversión</td>
                                                                                        <td><?= number_format($dividendos_esperados_uf, 2,',','.');?></td>
                                                                                        <td><?= number_format($dividendos_esperados_clp, 0,',','.');?></td>
                                                                                    </tr>
                                                                                    <tr class="tr-fondo-capital">
                                                                                        <td>Capital Devuelto</td>
                                                                                        <td><?= number_format($saldo_capital_entregado_uf, 2,',','.');?></td>
                                                                                        <td><?= number_format($saldo_capital_entregado_clp, 0,',','.');?></td>
                                                                                    </tr>
                                                                                    <tr class="tr-fondo-capital">
                                                                                        <td>Saldo de Capital por Recibir</td>
                                                                                        <td><?= number_format($monto_capital_por_recibir_uf = ($monto_capital_por_recibir_uf >=0)? $monto_capital_por_recibir_uf : "0", 2,',','.');?></td>
                                                                                        <td><?= number_format($monto_capital_por_recibir_clp = ($monto_capital_por_recibir_clp >=0) ? $monto_capital_por_recibir_clp : "0", 0,',','.');?></td>
                                                                                    </tr>
                                                                                    <tr class="tr-fondo-dividendos">
                                                                                        <td>Dividendos repartidos</td>
                                                                                        <td><?= number_format($saldo_dividendos_entregados_uf, 2,',','.' );?> </td>
                                                                                        <td> <?= number_format($saldo_dividendos_entregados_clp, 0,',','.'); ?></td>
                                                                                    </tr>
                                                                                    <tr class="tr-fondo-dividendos">
                                                                                        <td>Dividendos por Recibir (esperado)</td>
                                                                                        <td> <?=  number_format($monto_dividendos_por_recibir_uf = ($monto_dividendos_por_recibir_uf >=0) ? $monto_dividendos_por_recibir_uf : "0" , 2,',','.' );?></td>
                                                                                        <td><?=  number_format($monto_dividendos_por_recibir_clp = ($monto_dividendos_por_recibir_clp >=0) ? $monto_dividendos_por_recibir_clp : "0", 0,',','.' );?></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Valores Cuota</td>
                                                                                        <td>--</td>
                                                                                        <td><?php echo  number_format($valor_cuota, '2', ',', '.'); ?></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Saldo Contable (Ver Notas)</td>
                                                                                        <td> -- </td>
                                                                                        <td><?php echo  number_format($saldo_contable, '0', ',', '.'); ?></td>
                                                                                    </tr>
                                                                        ...
                                                                        <?php } else if(($fip->getMoneda()->moneda == 'EUR') || ($fip->getMoneda()->moneda == 'USD')) {?>
                                                                            ...
                                                                            <table class="table table-bordered fondo-cartola-claro rounded-cartola p-h3 text-white panel-title">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>ROE Esperado</td>
                                                                                        <td> <?= $fip->getMoneda()->moneda; ?> + <?= number_format($most_rent, 1,',','.');?> %</td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>Dividendos Esperados sobre Inversión</td>
                                                                                        <td><?= number_format($dividendos_esperados_uf, 0,',','.');?></td>
                                                                                        
                                                                                    </tr>
                                                                                    <tr class="tr-fondo-capital">
                                                                                        <td>Capital Devuelto</td>
                                                                                        <td><?= number_format($saldo_capital_entregado_uf, 0,',','.');?></td>
                                                                                        
                                                                                    </tr>
                                                                                    <tr class="tr-fondo-capital">
                                                                                        <td>Saldo de Capital por Recibir</td>
                                                                                        <td><?= number_format($monto_capital_por_recibir_uf, 0,',','.');?></td>
                                                                                        
                                                                                    </tr>
                                                                                    <tr class="tr-fondo-dividendos">
                                                                                        <td>Dividendos repartidos</td>
                                                                                        <td><?= number_format($saldo_dividendos_entregados_uf, 0,',','.' );?> </td>
                                                                                        
                                                                                    </tr>
                                                                                    <tr class="tr-fondo-dividendos">
                                                                                        <td>Dividendos por Recibir (esperado)</td>
                                                                                        <td> <?=  number_format($monto_dividendos_por_recibir_uf, 0,',','.' );?></td>
                                                                                        
                                                                                    </tr>

                                                                                    <tr>
                                                                                        <td>Valores Cuota</td>
                                                                                        <td><?php echo  number_format($resumen['valor_cuota'], '2', ',', '.'); ?></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Saldo Contable (Ver Notas)</td>
                                                                                        <td><?php echo  number_format($resumen['saldo_contable'], '0', ',', '.'); ?></td>
                                                                                    </tr>
                                                                        ...
                                                                        <?php } else {?>
                                                                            <table class="table table-bordered fondo-cartola-claro rounded-cartola p-h3 text-white panel-title">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr class="tr-fondo-capital">
                                                                                        <td>Saldo de Capital por Recibir</td>
                                                                                        <td><?= number_format($monto_capital_por_recibir_clp, 0,',','.');?></td>
                                                                                    ...
                                                                                    <tr class="tr-fondo-dividendos">
                                                                                        <td>Dividendos por Recibir (esperado)</td>
                                                                                        <td> <?=  number_format($monto_dividendos_por_recibir_clp, 0,',','.' );?></td>
                                    ...
                                    <div class="alert alert-grey container">
                                        ...
                                        <ol>
                                            ...
                                            <li><p>Todas las estimaciones de devolución de capital y dividendos esperados son calculadas en pesos en función de las estimaciones de inflación futura que hace el Banco Central de Chile en su IPOM y son ajustados trimestralmente.</p></li>

...
*/
$active_group = 'intranet_aicapitals';
$query_builder = TRUE;
...
/*
    $db['intranet_aicapitals'] = array(
        'hostname' => 'db-master-aicapitals-do-user-3147676-0.a.db.ondigitalocean.com',
        'port' => 25060,
        'username' => 'it_aicapitals',
        'password' => 'gyosinv53cgrnwep',
        'database' => 'aicapitals',
        'dbdriver' => 'postgre',
        'dbprefix' => '',
        'pconnect' => FALSE,
    ...
    */
    ...
    $db['webservices'] = array(
        'dsn'	=> '',
        'hostname' => 'api.aicapitals.cl',
        'username' => 'it_aicapitals',
        'password' => 'ITadminaicapitals.2017',
        'database' => 'reportes_aicapitals',
        'dbdriver' => 'mysqli',
    ...
    $db['intranet_aicapitals'] = array(
        'dsn'	=> 'pgsql:host=localhost;dbname=aicapitals',
        'hostname' => '',
        'username' => 'it_aicapitals',
        'password' => 'ITadminaicapitals.2017',
        'database' => 'aicapitals',
